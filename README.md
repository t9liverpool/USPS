...
* **Implimentation**：<br><br>This repository provides a pytorch-version implementation of USUP. The scripts was tested on CIFAR-10-10. Here are the running commands:<br><br>1. cd ./backbone<br>2. python3 run.py --dataset cifar-10-10 --split_idx 3  --data_root /root/data<br>3. cd ..<br>4. python3 cgan.py --dataset cifar10 --split 3<br>5. python3 usps.py --dataset cifar10 --split 3<br>
